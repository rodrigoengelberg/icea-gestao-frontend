    ...
    <>
      <div className="pb-10">
        ...
        <div className="py-5">
          ...
          TypeScript instead of templates, you can easily pass rich data through
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  and anything else your app needs go here.
                </td>
              </tr>
              <tr>
                <td colSpan={2}>
              ...
              <tr>
                ...
                <td>
                  Contains shared utils which are used by all application
                  modules.
                </td>
              </tr>
              <tr>
                ...
                <td>
                  Contains shared components which are used by all application
                  modules.
                </td>
              </tr>
              {/*<tr>
              ...
              <tr>
                ...
                <td>
                  Contains Layout core logic which is based on React.Context.
                  Also includes layout configuration
                  file(DefaultThemeConfig.ts).
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  Contains Layout components(Layout, Header, Aside, Footer...).
                </td>
              </tr>
              <tr>
                <td colSpan={2}>
              ...
              <tr>
                ...
                <td>
                  Contains application pages (Dashboard pages, Layout Builder
                  page...)
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td>package.json</td>
                <td>
                  A package.json file contains meta data about app or module.
                  Most importantly, it includes the list of dependencies to
