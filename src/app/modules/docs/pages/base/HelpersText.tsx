  ...
  return (
    <>
      <div className="pb-10">
        ...
        <div className="py-5">
          <div className="rounded border p-10">
            ...
            <p className="text-gray-100 bg-dark py-3 fw-bold fw-6">
              .text-gray-100
            </p>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          <div className="rounded border p-10">
            <p className="text-light-primary bg-primary p-3 fw-bold fw-6">
              .text-light-primary
            </p>
            <p className="text-light-success bg-success p-3 fw-bold fw-6">
              .text-light-success
            </p>
            <p className="text-light-info bg-info p-3 fw-bold fw-6">
              .text-light-info
            </p>
            <p className="text-light-warning bg-warning p-3 fw-bold fw-6">
              .text-light-warning
            </p>
            <p className="text-light-danger bg-danger p-3 fw-bold fw-6">
              .text-light-danger
            </p>
            <p className="text-light-dark bg-dark p-3 fw-bold fw-6">
              .text-light-dark
            </p>
          </div>
        </div>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          <div className="rounded border p-10">
            <p className="text-inverse-white bg-white p-3 fw-bold fw-6">
              .text-light-white
            </p>
            <p className="text-inverse-primary bg-primary p-3 fw-bold fw-6">
              .text-light-primary
            </p>
            <p className="text-inverse-secondary bg-secondary p-3 fw-bold fw-6">
              .text-light-secondary
            </p>
            <p className="text-inverse-light bg-light p-3 fw-bold fw-6">
              .text-light-light
            </p>
            <p className="text-inverse-success bg-success p-3 fw-bold fw-6">
              .text-light-success
            </p>
            <p className="text-inverse-info bg-info p-3 fw-bold fw-6">
              .text-light-info
            </p>
            <p className="text-inverse-warning bg-warning p-3 fw-bold fw-6">
              .text-light-warning
            </p>
            <p className="text-inverse-danger bg-danger p-3 fw-bold fw-6">
              .text-light-danger
            </p>
            <p className="text-inverse-dark bg-dark p-3 fw-bold fw-6">
              .text-light-dark
            </p>
          </div>
        </div>
