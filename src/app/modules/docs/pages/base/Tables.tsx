    ...
    <>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          ...
          <code>.gs-*</code>to set padding left to the first cell and padding
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          Use
          <code>.table-striped</code>&nbsp; to add zebra-striping to any table
          row within the
          <code>&lt;tbody&gt;</code>.
        </div>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          ...
          <code>.table-striped</code>&nbsp; to set bordered table with striped
          rows and make it rounded with
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          Use
          <code>.table-flush</code>&nbsp; to reset the table and cells base
