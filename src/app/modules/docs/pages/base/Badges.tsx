    ...
    <>
      <div className="card-body p-10 p-lg-15">
        ...
        <div className="py-10">
          ...
          <div className="py-5">
            Use
            <code>.badge-square</code>class to use a badge with same width and
            height:
          </div>
          ...
          <div className="py-5">
            <div className="rounded border p-10 pb-0 d-flex flex-wrap align-items-center">
              ...
              <span className="badge badge-square badge-primary me-10 mb-10">
                5
              </span>
              <span className="badge badge-square badge-light me-10 mb-10">
                5
              </span>
              <span className="badge badge-square badge-secondary me-10 mb-10">
                5
              </span>
              <span className="badge badge-square badge-success me-10 mb-10">
                5
              </span>
              <span className="badge badge-square badge-info me-10 mb-10">
                5
              </span>
              <span className="badge badge-square badge-warning me-10 mb-10">
                5
              </span>
              <span className="badge badge-square badge-danger me-10 mb-10">
                5
              </span>
              <span className="badge badge-square badge-dark me-10 mb-10">
                5
              </span>
            </div>
          </div>
        ...
        <div className="py-10">
          ...
          <div className="py-5">
            <div className="rounded border p-10 pb-0 d-flex flex-wrap align-items-center">
              ...
              <span className="badge badge-circle badge-primary me-10 mb-10">
                5
              </span>
              <span className="badge badge-circle badge-light me-10 mb-10">
                5
              </span>
              <span className="badge badge-circle badge-secondary me-10 mb-10">
                5
              </span>
              <span className="badge badge-circle badge-success me-10 mb-10">
                5
              </span>
              <span className="badge badge-circle badge-info me-10 mb-10">
                5
              </span>
              <span className="badge badge-circle badge-warning me-10 mb-10">
                5
              </span>
              <span className="badge badge-circle badge-danger me-10 mb-10">
                5
              </span>
              <span className="badge badge-circle badge-dark me-10 mb-10">
                5
              </span>
            </div>
