    ...
    <>
      <div className="pb-10">
        ...
        <div className="py-5">
          ...
          <a
            href={`${REACT_APP_BOOTSTRAP_DOCS_LINK}/components/card/`}
            className="fw-bold"
          >
            Bootstrap Card
          </a>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          Use
          <code>.card-flush</code>class to remove a card header and footer
          borders:
        </div>
        <div className="py-5">
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          Add
          <code>.card-px-0</code>to reset a card header, body and footer's side
          paddings:
        </div>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          Add
          <code>.card-border</code>to a card to remove it's shadow and enable
          border.
        </div>
      ...
      <div className="pt-10">
        ...
        <div className="py-5">
          ...
          <ul className="pt-3">
            ...
            <li className="py-2">
              <code>card-rounded-top</code>- to set top left and top right
              radiuses of card
            </li>
            <li className="py-2">
