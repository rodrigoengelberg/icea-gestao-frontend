  ...
  return (
    <>
      <div className="pb-10">
        ...
        <div className="py-5">
          Separator is a custom component to used to device page blocks with
          space and visual line.
        </div>
      </div>
      <div className="pt-10">
        ...
        <div className="py-5">
          Use
          <code>.separator</code>class to place a separator with border color
