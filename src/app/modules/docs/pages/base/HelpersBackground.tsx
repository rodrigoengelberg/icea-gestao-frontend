  ...
  return (
    <>
      <div className="pb-10">
        ...
        <div className="py-5">
          <div className="rounded border p-10">
            <p className="bg-white text-inverse-white p-3 fw-bold fw-6">
              .bg-white
            </p>
            <p className="bg-primary text-inverse-primary p-3 fw-bold fw-6">
              .bg-primary
            </p>
            <p className="bg-light text-inverse-light p-3 fw-bold fw-6">
              .bg-light
            </p>
            <p className="bg-secondary text-inverse-secondary p-3 fw-bold fw-6">
              .bg-secondary
            </p>
            <p className="bg-success text-inverse-success p-3 fw-bold fw-6">
              .bg-success
            </p>
            <p className="bg-info text-inverse-info p-3 fw-bold fw-6">
              .bg-info
            </p>
            <p className="bg-warning text-inverse-warning p-3 fw-bold fw-6">
              .bg-warning
            </p>
            <p className="bg-danger text-inverse-danger p-3 fw-bold fw-6">
              .bg-danger
            </p>
            <p className="bg-dark text-inverse-dark p-3 fw-bold fw-6">
              .bg-dark
            </p>
          </div>
        </div>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          <div className="rounded border p-10">
            <p className="bg-light-primary text-primary p-3 fw-bold fw-6">
              .bg-light-primary
            </p>
            <p className="bg-light-success text-success p-3 fw-bold fw-6">
              .bg-light-success
            </p>
            <p className="bg-light-info text-info p-3 fw-bold fw-6">
              .bg-light-info
            </p>
            <p className="bg-light-warning text-warning p-3 fw-bold fw-6">
              .bg-light-warning
            </p>
            <p className="bg-light-danger text-danger p-3 fw-bold fw-6">
              .bg-light-danger
            </p>
            <p className="bg-light-dark text-dark p-3 fw-bold fw-6">
              .bg-light-dark
            </p>
          </div>
        </div>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          <div className="rounded border p-10">
            ...
            <p className="text-gray-600 bg-info hoverable p-3 fw-bold fw-6">
              .bg-info .hoverable
            </p>
            ...
            <p className="text-gray-600 bg-dark hoverable p-3 fw-bold fw-6">
              .bg-dark .hoverable
            </p>
          </div>
        </div>
