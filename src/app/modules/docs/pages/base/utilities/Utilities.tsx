    ...
    <>
      <div className="pb-10">
        ...
        <div className="py-5">
          ...
          <a
            href={`${REACT_APP_BOOTSTRAP_DOCS_LINK}/utilities/api`}
            className="fw-bold"
          >
            Bootstrap Utility API
          </a>
          &nbsp; in
          <code>{REACT_APP_SASS_PATH}/_utilities.scss</code>to generate
          additional utility classes to cover its own design system. The
          customized utility SASS variables are defined in
          <code>{REACT_APP_SASS_PATH}/_variables.scss</code>and in
          <code>{REACT_APP_SASS_PATH}/_variables.custom.scss</code>you can
          override any variable for your needs.
        </div>
      </div>
      <Example1ThemeColors />
      <Example2Spacing />
