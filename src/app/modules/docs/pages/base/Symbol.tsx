  ...
  return (
    <>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          Use
          <code>.symbol-2by3</code>class to set avatar background image with 2
          by 3 ratio:
        </div>
        <div className="py-5">
          <div className="rounded border p-10 pb-0 d-flex flex-wrap">
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          ...
          <code>.symbol-label</code>element and style it with text and
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          <div className="rounded border p-10 pb-0 d-flex flex-wrap">
            ...
            <div className="symbol symbol-50px me-10 mb-10">
              <div className="symbol-label fs-2 fw-bold">A</div>
              <span className="badge badge-circle bg-danger start-0 top-100">
                3
              </span>
            </div>
          </div>
      ...
      <div className="py-10">
        ...
        <div className="py-5">
          Wrap symbols with
          <code>.symbol-group</code>class to have a group with slighly
          overlapped symbols:
        </div>
